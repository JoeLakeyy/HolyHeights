...
L.tileLayer(
  "https://tiles.stadiamaps.com/tiles/stamen_toner_dark/{z}/{x}/{y}{r}.{ext}",
  {
    ...
    maxZoom: 20,
    attribution:
      '&copy; https://www.stadiamaps.com/Stadia Maps</a> &copy; https://www.stamen.com/Stamen Design</a> &copy; https://openmaptiles.org/OpenMapTiles</a> &copy; https://www.openstreetmap.org/copyrightOpenStreetMap</a>',
    ext: "png"
  }
).addTo(map);
...
============================ */
const iconMap = {
  cathedral: "https://joelakeyy.github.io/icons/cathedral-svgrepo-com.svg",
  mosque: "https://joelakeyy.github.io/icons/mosque-svgrepo-com.svg",
  pyramid: "https://joelakeyy.github.io/icons/pyramid-svgrepo-com.svg",
  stupa: "https://joelakeyy.github.io/icons/stupa-svgrepo-com.svg",
  synagogue: "https://joelakeyy.github.io/icons/synagogue-svgrepo-com.svg",
  gopura: "https://joelakeyy.github.io/icons/hindu-temple-svgrepo-com.svg",
  temple: "https://joelakeyy.github.io/icons/hindu-temple-stupa-svgrepo-com.svg",
  statue: "https://joelakeyy.github.io/icons/great-buddha-of-nara-1-svgrepo-com.svg",
  pagoda: "https://joelakeyy.github.io/icons/pagoda-svgrepo-com.svg"
};
...
function getRowsForYearFiltered(year) {
  ...
  return allRows.filter(r => {
    ...
    if (!selectedReligions.has(r.religion_origin)) return false;
...
/* ============================
   LOAD DATA
============================ */
fetch("https://raw.githubusercontent.com/JoeLakeyy/JoeLakeyy.github.io/refs/heads/main/Prevalence_religion_V4.csv")
  .then(r => r.text())
  .then(text => {
    ...
    allRows.forEach(r => {
      if (r.religion_origin && r.religion_origin !== "NA") religions.add(r.religion_origin);
...
fetch("https://raw.githubusercontent.com/JoeLakeyy/JoeLakeyy.github.io/refs/heads/main/year_religion.csv")
  .then(r => r.text())
  .then(text => {
